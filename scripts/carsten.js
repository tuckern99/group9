var sal_person_plot = function(data) {
    ...
    var xV = data.openess_to_experience
    var xAccessor = d => d.openess_to_experience
    ...
    .style('font-size', 20)
    .text('Salary and Openness to Experience');
    ...
    .enter()
    .append("circle")
        .attr("cx", function (d) { return x(d.openess_to_experience) } )
